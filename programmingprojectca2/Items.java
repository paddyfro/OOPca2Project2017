...
public class Items
{
    ...
    {
        return "{" + getClass().getName() + ", type=" + type + ", title=" + title + ", genre=" + genre + ", description=" + description + ", price=" + price + ", releaseYear=" + releaseYear;
    }
...
//  make a DEEP COPY of the existing object (i.e. a separate/unique object in memory)
        Items clone = new Items(this.type,this.title, this.genre, this.description, this.price, this.releaseYear);
